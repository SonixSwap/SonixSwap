...
const Farms: React.FC = () => {
  ...
  const farmsList = useCallback(
    (farmsToDisplay, removed: boolean) => {
      ...
      const farmsToDisplayWithAPR = farmsToDisplayWithAPY.filter(farm => farm.pid !== 1 && farm.pid !== 5)
      return farmsToDisplayWithAPR.map((farm) => (
        <FarmCard
          key={farm.pid}
          farm={farm}
          removed={removed}
  ...
  return (
    <Page>
      ...
      <Image src="/images/farm-bg.png" alt="KiwiFinance illustration" width={1080} height={600} responsive />
    </Page>
  )
}
